...
export default class HandGestureView {
  ...
  #fingerLookupIndexes;
  #styler;
  constructor({ fingerLookupIndexes, styler, canvasRef }) {
    this.#handsCanvas = canvasRef.current;
    this.#styler = styler;
  ...
  #drawFingersAndHoverElements(keyPoints) {
    ...
    for (const finger of fingers) {
      ...
      if (finger === "indexFinger") this.#hoverElements(points);
  ...
  #hoverElements(points) {
    const tip = points.find(({ name }) => name === "index_finger_tip");
